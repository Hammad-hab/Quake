...
Sys.FlushConfiguration = function()
{
	if ((Host.initialized !== true) || (Host.configDirty !== true))
		return;
...
Sys.FlushGameSave = function()
{
	if (Host.initialized === true)
		Host.AutoSaveSlot();
};

Sys.onpagehide = function()
{
	Sys.FlushGameSave();
	Sys.FlushConfiguration();
};

Sys.onvisibilitychange = function()
{
